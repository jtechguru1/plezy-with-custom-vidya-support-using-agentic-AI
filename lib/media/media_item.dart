...
sealed class MediaItem with _$MediaItem {
  ...
  factory MediaItem({
    ...
    return switch (backend) {
      ...
      MediaBackend.vidya => VidyaMediaItem(
        id: id,
        kind: kind,
        guid: guid,
        title: title,
  ...
  /// Backend-tagged concrete subclass for items sourced from a VIDYA server.
  @FreezedUnionValue('vidya')
  @JsonSerializable(includeIfNull: false, explicitToJson: true)
  const factory MediaItem.vidya({
    @JsonKey(readValue: readStringField, defaultValue: '') required String id,
    @JsonKey(fromJson: _mediaKindFromJson, toJson: _mediaKindToJson) required MediaKind kind,
    String? guid,
    String? title,
  ...
  MediaBackend get backend => switch (this) {
    ...
    VidyaMediaItem() => MediaBackend.vidya,
  };
  ...
  factory MediaItem.fromJson(Map<String, dynamic> json) {
    return switch (MediaBackend.fromString(json['backend'] as String?)) {
      ...
      MediaBackend.vidya => _$VidyaMediaItemFromJson(json),
    };
  }
  ...
  Map<String, dynamic> toJson() {
    return switch (this) {
      ...
      final VidyaMediaItem item => {'backend': MediaBackend.vidya.id, ..._$VidyaMediaItemToJson(item)},
    };
  }
